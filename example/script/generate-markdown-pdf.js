...
//
// # Generates a PDF
// yarn node example/script/generate-markdown-pdf.js <apiKey> [<inputJSONFile>]
//
// # Generates a PDF with default data, then open the new PDF in preview
// yarn node example/script/generate-markdown-pdf.js 5vqCxtgNsA2uzgMH0ps4cyQyadhA2Wdt && open example/script/generate.output.pdf
//
// # Generate a PDF with your payload, then open the new PDF in preview
// yarn node example/script/generate-markdown-pdf.js apiKeydef345 ./payload.json && open example/script/generate.output.pdf
//
